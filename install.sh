...
echo ""
echo "已安装的 Skills："
echo "  /aiyu:init-project      新项目初始化"
echo "  /aiyu:add-module        添加业务模块"
echo "  /aiyu:entropy-review    熵减审计"
echo "  /aiyu:migrate-project   旧项目迁移"
echo ""
echo "脚本模板位置："
...
echo "  2. 新项目初始化：/aiyu:init-project"
echo "  3. 旧项目迁移：/aiyu:migrate-project"
echo ""
